...
namespace Mundo2
{
    public class AndyController : MonoBehaviour
    {
        ...
        public Vector3 offset = new Vector3(0f, 1.3f, 0f); // X centrado, Y arriba
        ...
        void Awake()
        {
            ...
            // Guardamos la escala inicial para no deformarlo
        ...
        void Update()
        {
            if (objetivo != null)
            {
                // 1. POSICIÓN (Sobre la cabeza con flote)
        ...
        void ActualizarGiro()
        {
            // Detectamos si Lupi giró por ESCALA o por FLIP X
            ...
            // Aplicamos el giro a Andy
            // Si Andy mira al lado contrario de lo que quieres, cambia los signos de escalaOriginalX
